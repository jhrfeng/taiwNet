...
(function($, UI) {
    ...
    UI.component('tab', {
        ...
        init: function() {
            ...
            this.on("click mouseover", this.options.target, function(e) {
                e.preventDefault();
            ...
            // handle click
            this.responsivetab.lst.on('click mouseover', 'a', function(e) {
            ...
            UI.dropdown(this.responsivetab, {"mode": "click mouseover"});
